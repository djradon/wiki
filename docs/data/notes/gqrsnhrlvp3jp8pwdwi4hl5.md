...
- topices: [[t.humanities.digital]] [[t.lit.character]]
...
- @vladimir-propp’s theory is an important precursor for the perspective known as [[t.lit.structuralism]]
...
- [[t.lit.character.greimas-six-actants]]
...
- @fotis-jannidis's approach is based on theories belonging to linguistic and cognitive science oriented literature studies
  ...
  - proposed [[t.lit.communication.jannidis-three-levels]]
